...
const RegisterForm: React.FC = () => {
  ...
  const [createUser, { isLoading, error, isSuccess, data: userData }] =
    chatAPI.useСreateNewUserMutation();

  console.log("su", isSuccess, "data", userData);
  ...
  return (
    ...
    >
      ...
      {isSuccess && userData && (
        <Alert severity="success">Имя пользователя: {userData.username}</Alert>
      )}
      ...
      >
        {isSuccess ? "Регистрация..." : "Зарегистрироваться"}
      </StyledButton>
      <StyledLink href="/login">или войти</StyledLink>
    </StyldedBox>
  );
};
